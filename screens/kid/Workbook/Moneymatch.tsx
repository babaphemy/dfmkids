...
const Moneymatch = () => {
	...
	const checkDrop = (event, gestureState, bounds, id) => {
		...
		if (gestureState.moveX > 260 && gestureState.moveX < 320) {
			...
			if (gestureState.moveY > 385 && gestureState.moveY < 440) {
				if (id === 'Nickel') {
					setSorted({
						...sorted,
						Nickel: true,
			...
			} else if (gestureState.moveY > 538 && gestureState.moveY < 612) {
				if (id === 'Penny') {
					setSorted({
						...sorted,
						Penny: true,
			...
			} else if (gestureState.moveY > 312 && gestureState.moveY < 374) {
				if (id === 'Dime') {
					setSorted({
						...sorted,
						Dime: true,
			...
			} else if (gestureState.moveY > 473 && gestureState.moveY < 534) {
				if (id === 'Quarter') {
					setSorted({
						...sorted,
						Quarter: true,
